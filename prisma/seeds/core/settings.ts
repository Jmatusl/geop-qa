...
export async function seedSettings(prisma: PrismaClient, adminUserId: string) {
  ...
  const recoveredSettings = [
    ...
    },
    {
      ...
      description: "Reglas de notificación para vencimiento de certificaciones",
      hasCustomUi: true,
      value: {
        unconfirmedRetryLimit: 5,
        thresholds: [
          {
            days: 90,
            name: "preventiva",
            targetRoles: ["USUARIO"],
            digestRoles: ["OPERADOR", "SUPERVISOR"],
            requiresAck: false,
            channels: ["email"],
          },
          {
          ...
          },
          {
            ...
            name: "critica",
            targetRoles: ["USUARIO"],
            digestRoles: ["ADMIN", "SUPERVISOR", "OPERADOR"],
            requiresAck: true,
            channels: ["email"],
          },
        ],
  ...
  const recoveredMenus = [
    ...
    },
    {
      ...
      children: [
        ...
        { key: "settings", title: "Configuraciones", icon: "Settings", path: "/mantenedores/configuraciones", enabled: true, order: 20, showIcon: true, roles: ["ADMIN"] },
    ...
    },
    {
      key: "mantencion",
      title: "Mantenimiento",
      icon: "Settings", // Represents maintenance/settings
      path: "/mantencion",
      enabled: true,
      order: 81,
      showIcon: true,
      ...
      children: [
        ...
        {
          key: "mantencion-notificaciones",
          title: "Mis Notificaciones",
          icon: "Bell",
          path: "/mantencion/notificaciones",
          enabled: true,
          order: 50,
          showIcon: true,
          roles: ["ADMIN", "SUPERVISOR", "OPERADOR", "USUARIO"],
