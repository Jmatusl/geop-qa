...
-- AddForeignKey
ALTER TABLE "supply_request_items" ADD CONSTRAINT "supply_request_items_unit_id_fkey" FOREIGN KEY ("unit_id") REFERENCES "unit_master"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
