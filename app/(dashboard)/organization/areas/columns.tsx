...
import { Area } from "@/lib/hooks/use-areas";

export type SortDirection = "asc" | "desc" | null;

interface GetAreasColumnsProps {
...
export const getAreasColumns = ({ onEdit, onDelete, currentSort, onSort }: GetAreasColumnsProps): ColumnDef<Area>[] => [
    {
        accessorKey: "code",
