...
import { JobPosition } from "@/lib/hooks/use-job-positions";

export type SortDirection = "asc" | "desc" | null;

interface GetJobPositionsColumnsProps {
...
export const getJobPositionsColumns = ({ onEdit, onDelete, currentSort, onSort }: GetJobPositionsColumnsProps): ColumnDef<JobPosition>[] => [
    {
        accessorKey: "code",
