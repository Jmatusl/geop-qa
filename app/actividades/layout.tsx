...
export default async function ActividadesLayout({ children }: { children: React.ReactNode }) {
  // 1. Verificar sesión
  ...
  try {
    ...
    console.error("Error cargando UI_CONFIG para layout de Actividades:", error);
  }
