...
import { useJobPositions, useDeleteJobPosition, JobPosition, useJobPosition } from "@/lib/hooks/mantencion/use-job-positions";
import { getJobPositionsColumns, SortDirection } from "./columns";
import { JobPositionForm } from "@/components/mantencion/job-position-form";
...
export default function JobPositionsPage() {
  ...
  // @ts-ignore
  const { mnt_cargos: texts } = maintenanceConfig;
  ...
  const { data: itemToEdit, isLoading: isLoadingItem } = useJobPosition(editId);
  ...
  const [externalItem, setExternalItem] = useState<JobPosition | null | undefined>(undefined);
